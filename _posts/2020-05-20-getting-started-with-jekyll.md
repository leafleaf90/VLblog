...
1 Install Ruby on your machine. I'm on Windows so I used the installer package: [Ruby](https://www.ruby-lang.org/en/){:target="blank"}
...
If you already have an HTML site that you want to convert Jekyll, follow the [official Jekyll guide](https://jekyllrb.com/tutorials/convert-site-to-jekyll/){:target="blank"} on converting a site to Jekyll.
...
Now you can dive into the Jekyll documentation to learn more about how you can build your site. You should also learn about the [Liquid](https://shopify.github.io/liquid/){:target="blank"} template language which is used in Jekyll. If you come from any of the modern JavaScript frameworks, you will quickly pick up the Liquid syntax which allows you to loop over and conditionally display data in the HTML part of your code. If you have built Shopify storefronts you will be right at home, since Shopify also uses Liquid.
