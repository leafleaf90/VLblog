...
description: "A quick look at using DaisyUI with Tailwind to move faster without hand-rolling every component."
categories: tailwind
---

## What you'll learn

- How DaisyUI fits on top of Tailwind.
- How to install the library in a frontend project.
- Why component libraries can speed up small UI builds.
